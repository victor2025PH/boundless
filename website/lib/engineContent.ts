...
export const ENGINE: EngineDict = {
  ...
  proof: {
    ...
    videoDesc: { zh: "克隆形象 + 克隆声 + 口型同步，会眨眼摆头的活体分身。", en: "Cloned face + cloned voice + lip-sync — a living twin that blinks and moves." },
    videoSrc: "/showcase/real/digital-human.mp4?v=20260708",
    videoPoster: "/showcase/real/digital-human-poster.png?v=20260708",
