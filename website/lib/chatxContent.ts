...
export const CHATX = {
  download: {
    ...
    version: "1.0.89",
    size: { zh: "550 MB", en: "550 MB" },
    filename: "ChatX-Setup-1.0.89.exe",
    os: { zh: "Windows 10 / 11（64 位）", en: "Windows 10 / 11 (x64)" },
    url: `${CHATX_RELEASE_BASE}/ChatX-Setup-1.0.89.exe`,
    /** 与实际上架 /downloads/ 的安装包一致（scripts/gen-chatx-manifest.ps1 计算）；
     *  运行时会被 manifest.json 的值覆盖。 */
    sha256: "88ac8dbf0ff04e44352994c513352201292d503044a2e1b39735546564d5e020",
