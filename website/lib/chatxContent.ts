...
export const CHATX = {
  download: {
    ...
    version: "1.0.93",
    size: { zh: "551 MB", en: "551 MB" },
    filename: "ChatX-Setup-1.0.93.exe",
    os: { zh: "Windows 10 / 11（64 位）", en: "Windows 10 / 11 (x64)" },
    url: `${CHATX_RELEASE_BASE}/ChatX-Setup-1.0.93.exe`,
    /** 与实际上架 /downloads/ 的安装包一致（scripts/gen-chatx-manifest.ps1 计算）；
     *  运行时会被 manifest.json 的值覆盖。 */
    sha256: "e991f80c6bb92104e8e590d624364117b7f0c4246b0e62b68b631dad20caebb1",
