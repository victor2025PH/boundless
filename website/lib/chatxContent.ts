...
export const CHATX = {
  download: {
    ...
    // 2026-09-04 随 1.0.73 发版同步；2026-09-06 随 1.0.74 发版同步（K-5 ③）；2026-09-06 随 1.0.75 发版同步（L-7 E）；2026-09-07 随 1.0.76 发版同步（M-6 C）；2026-09-08 随 1.0.77 发版同步（N-5 E）；2026-09-08 随 1.0.78 发版同步（R78）；2026-09-10 随 1.0.79 发版同步（R79）；2026-09-11 随 1.0.80 发版同步（R80）；2026-09-11 随 1.0.81 发版同步（R81，单一版本）；2026-09-11 随 1.0.82 发版同步（R82）；2026-09-12 随 1.0.84 发版同步（R84）；2026-09-13 随 1.0.85 发版同步（R85）；2026-09-16 随 1.0.86 发版同步（R86）。
    version: "1.0.86",
    size: { zh: "504 MB", en: "504 MB" },
    filename: "ChatX-Setup-1.0.86.exe",
    os: { zh: "Windows 10 / 11（64 位）", en: "Windows 10 / 11 (x64)" },
    url: `${CHATX_RELEASE_BASE}/ChatX-Setup-1.0.86.exe`,
    /** 与实际上架 /downloads/ 的安装包一致（scripts/gen-chatx-manifest.ps1 计算）；
     *  运行时会被 manifest.json 的值覆盖。 */
    sha256: "e0687a161bcb425cd4578c501667b41ce3624199fe35f2dbcafdfc3bd0644aad",
