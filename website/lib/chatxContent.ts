...
export const CHATX = {
  download: {
    version: "0.1.0",
    size: { zh: "237 MB", en: "237 MB" },
    filename: "ChatX-Setup-0.1.0.exe",
    os: { zh: "Windows 10 / 11（64 位）", en: "Windows 10 / 11 (x64)" },
    url: `${CHATX_RELEASE_BASE}/ChatX-Setup-0.1.0.exe`,
    /** 与实际上架 /downloads/ 的安装包一致（certutil -hashfile 计算）；
     *  运行时会被 manifest.json 的值覆盖。 */
    sha256: "5a827dddb2ffeaf9f1c5fa9435d1fb3c2a1488720c7d0aa44bd4c26668462986",
    ...
    steps: [
      {
        ...
        detail: {
          zh: "点击本页下载按钮获取 **ChatX-Setup-0.1.0.exe**（约 237 MB，含桌面壳与本地服务，一次到位无需再下组件）。",
          en: "Click the download button to get **ChatX-Setup-0.1.0.exe** (~237 MB, desktop shell plus local backend in one package — no extra components).",
        },
      },
      {
