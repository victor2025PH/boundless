              ...
              <Reveal key={m.id} delay={i * 0.06} className="h-full">
                ...
                >
                  ...
                  <div className="mt-auto pt-5">
                    ...
                    <p className="mt-1 text-xs text-slate-500">{m.priceNote}</p>
                ...
                {rt.plans.map((p) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {p.tag && (
                        <span className="rounded-full bg-white/10 px-2 py-0.5 text-[11px] text-slate-300">{p.tag}</span>
                      )}
                    </div>
          ...
          {active === "invest" && (
            <div className="grid gap-6 lg:grid-cols-2">
              <div className="rounded-2xl border border-neon-violet/25 bg-ink-900/40 p-6">
                ...
                <p className="mt-4 text-xs leading-relaxed text-slate-500">{e.invest.roiNote}</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-ink-900/40 p-6">
                ...
                <ol className="space-y-3">
                  {e.invest.flow.map((f, i) => (
                    <li key={f} className="flex items-start gap-3 text-sm text-slate-300">
                      <span className="grid h-6 w-6 shrink-0 place-items-center rounded-full bg-gradient-to-br from-neon-cyan to-neon-violet text-xs font-bold text-ink-950">
                        {i + 1}
                      </span>
                      {f}
                    </li>
                ...
                <p className="mt-5 rounded-lg border border-white/10 bg-white/5 p-3 text-xs leading-relaxed text-slate-400">
                  {e.invest.compliance}
                </p>
              </div>
            </div>
