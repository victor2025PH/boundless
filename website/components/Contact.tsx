      ...
      <div className="relative mx-auto max-w-5xl px-5">
        ...
        >
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            <div className="contact-card flex flex-col rounded-2xl border border-white/10 bg-ink-900/60 p-6">
            ...
            <div className="contact-card rounded-2xl border border-white/10 bg-ink-900/60 p-6">
              ...
              <p className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-emerald-400/30 bg-emerald-400/10 px-2.5 py-1 text-xs font-medium text-emerald-300">
