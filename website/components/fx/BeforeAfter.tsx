...
export default function BeforeAfter({
  ...
  return (
    <div
      ref={ref}
      className={`group relative ${aspectClass} w-full cursor-ew-resize touch-none select-none overflow-hidden rounded-2xl border border-neon-cyan/25 bg-ink-900 ${className}`}
      onPointerDown={(e) => {
