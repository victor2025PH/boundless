...
import { EveBot, type BotMode } from "./AISprite";
...
export default function RobotStage() {
  const [params, setParams] = useState<{ mode: BotMode; scale: number; bg: string; pool: boolean } | null>(null);
