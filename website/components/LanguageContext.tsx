...
const DUAL_LOCALE_BASES = new Set(["", "/voice", "/face", "/interpreting", "/privacy", "/terms", "/order", "/download", "/manual", "/videos", "/film", "/brand", "/growth", "/matrix", "/matrix/download", "/compliance/crisis-protocol", "/compare/respond-io", "/compare/salesmartly"]);
