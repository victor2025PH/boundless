  ...
  return (
    <section className="relative py-16">
      <div className="mx-auto max-w-5xl px-5">
        <Reveal>
          <div className="promo-panel relative overflow-hidden rounded-3xl border border-neon-cyan/25 bg-gradient-to-br from-neon-cyan/10 via-ink-900/60 to-neon-violet/10 p-8 md:p-12">
            <div className="promo-glow-cyan pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full bg-neon-cyan/15 blur-3xl" />
            <div className="promo-glow-violet pointer-events-none absolute -bottom-16 -left-16 h-56 w-56 rounded-full bg-neon-violet/15 blur-3xl" />
            ...
            <div className="relative flex flex-col items-center gap-8 md:flex-row md:justify-between">
              ...
              <div className="flex shrink-0 flex-col gap-3 sm:flex-row">
                ...
                <motion.a
                  ...
                  className="promo-outline-btn inline-flex items-center justify-center gap-2 rounded-full border border-neon-cyan/40 bg-neon-cyan/10 px-7 py-3.5 text-sm font-semibold text-neon-cyan"
                >
