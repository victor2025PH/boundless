  ...
  return (
    <section id="unlock" className="relative py-16">
      <div className="mx-auto max-w-3xl px-5">
        <Reveal>
          <div className="promo-panel gate-panel relative overflow-hidden rounded-3xl border border-neon-violet/30 bg-gradient-to-br from-neon-violet/10 via-ink-900/70 to-neon-cyan/10 p-8 md:p-10">
            <div className="promo-glow-violet pointer-events-none absolute -right-20 -top-20 h-56 w-56 rounded-full bg-neon-violet/15 blur-3xl" />
                ...
                <>
                  ...
                  <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-center">
                    ...
                    <a
                      ...
                      className={`inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-semibold ${group ? "border border-emerald-500/50 bg-emerald-500/10 text-emerald-300" : "promo-outline-btn border border-neon-cyan/40 bg-neon-cyan/10 text-neon-cyan"}`}
                    >
