        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <Reveal delay={0.1}>
            ...
            <a
              ...
              className="cta-fx group mt-6 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-neon-cyan to-neon-violet px-6 py-3 text-sm font-semibold text-ink-950 transition hover:opacity-90"
            >
              {a.cta}
                ...
                >
                  ...
                  <div className="grid sm:grid-cols-2">
                    <div className="flex items-start gap-2 border-b border-white/10 p-4 sm:border-b-0 sm:border-r">
                      ...
                      <div>
                        <span className="block text-xs font-medium text-red-400/80">{a.badLabel}</span>
                    ...
                    <div className="flex items-start gap-2 bg-neon-cyan/[0.04] p-4">
                      ...
                      <div>
                        <span className="block text-xs font-medium text-emerald-400">{a.goodLabel}</span>
