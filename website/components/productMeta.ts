...
// 产品专属玻璃 3D 图标（透明底）：由 scripts/build-boundless-marks.ps1 从 {key}-white.png
// 抠白生成 public/brand/products/{key}.png（与主 ∞ 标识同一视觉语言）。
// TODO: voxx 暂复用同系(通达) lingox 图标，待 build-boundless-marks 生成 voxx.png 后替换。
export const PRODUCT_IMG: Record<ProductKey, string> = {
  ...
  voxx: "/brand/products/lingox.png",
};
