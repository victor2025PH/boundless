...
const COPY: Record<"zh" | "en", PickerCopy> = {
  zh: {
    ...
    results: {
      translate: {
        name: "智聊 ChatX · 翻译套餐",
        reason: "多平台双向拟人翻译 + 统一收件箱（已内置于智聊客户端），不会外语也能全球接单。",
        primary: { label: "看聊天翻译能力", href: "/interpreting#chat" },
        secondary: { label: "查看价格", href: "/order" },
      },
      autochat: {
        name: "智聊 ChatX",
        reason: "AI 按你的人设 7×24 答疑跟单，关键节点一键人工接管。",
        primary: { label: "看 AI 成交演示", href: "#autochat" },
        secondary: { label: "查看套餐", href: "/order" },
      },
      voice: {
        name: "幻声 VoiceX",
  ...
  en: {
    ...
    results: {
      translate: {
        name: "ChatX · Translate Plans",
        reason: "Human-like two-way translation across platforms with a unified inbox — built into the ChatX client, serve global customers without speaking their language.",
        primary: { label: "See chat translation", href: "/en/interpreting#chat" },
        secondary: { label: "See pricing", href: "/en/order" },
      },
      autochat: {
        ...
        secondary: { label: "See plans", href: "/en/order" },
      },
      voice: {
