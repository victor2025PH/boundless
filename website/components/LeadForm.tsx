...
export default function LeadForm() {
  ...
  return (
    <div className="form-beam mt-6 rounded-2xl border border-white/10 bg-ink-900/40 p-6 md:p-8">
      ...
      <AnimatePresence mode="wait">
        {status === "ok" ? (
          <motion.div
            ...
            className="relative mt-6 flex flex-col items-center gap-2 rounded-xl border border-emerald-400/30 bg-emerald-400/10 px-6 py-8 text-center"
          >
            {/* 成交时刻的彩纸爆发:从对勾图标处炸开,一次性 */}
            <Burst />
          ...
          >
            ...
            <div>
              ...
              />
              {showContactErr && (
                <p id="lead-contact-err" className="mt-1.5 text-xs text-rose-400">
                  {f.contactInvalid}
                </p>
              )}
            </div>
            ...
            <div className="md:col-span-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <span className="text-xs text-slate-500">{f.privacy}</span>
            </div>
