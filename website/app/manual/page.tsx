...
export const metadata: Metadata = {
  title: "幻境 STUDIO 使用手册 · 无界科技 BOUNDLESS",
  description:
    "幻境 STUDIO 实时数字人引擎完整使用手册：系统要求、下载安装、激活使用、声音克隆、直播换脸、手机同传、软件更新与故障排查。支持在线阅读与打印导出 PDF。",
  alternates: {
    canonical: "/manual",
...
const guideLd = {
  ...
  "@type": "TechArticle",
  headline: "幻境 STUDIO 使用手册",
  about: "幻境 STUDIO 实时数字人引擎的安装、激活、使用与故障排查指南",
  inLanguage: "zh-CN",
