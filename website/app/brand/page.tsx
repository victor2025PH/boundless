...
const COPY = {
  ...
  en: {
    ...
    breakLabel: "Breaks",
    productsHead: "Six product lines · Six barriers broken",
            ...
            {PRODUCT_ORDER.map((key, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-3 inline-flex items-center gap-1 rounded-full bg-neon-violet/10 px-2.5 py-1 text-xs font-medium text-neon-violet">
