...
**1.0.73 已打内测+干净包。** 官网下载指针与 R2 已切 1.0.73；yunsheng 已装 1.0.73。
kouxing / lianbei 当时 LAN 不可达（ping/ssh 超时），坐席机还停在 1.0.72，网回来再 `push_chatx`。
I-5 剩余项与 I-2 三项 UI、guard-check 影子、P0 FD 闸均已进包。I-6 61 单回访仍等老板点头。
