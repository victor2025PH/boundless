...
|---|---|---|---|---|---|---|---|---|
| **I-1** | #160 风险扣稿全放行（影子台账档）+ 分类器整词化 + #162 观测补丁 | #160 #162 | **$150** | 已完成（2026-09-04 10:4x，含二批） | B `da7a8787` / A `58aed354` / C `a667783c` / D `10dc0a84`；二批台账维度+放行去向 `067a0b62` `28864be4`；三批 peer_msg_id+delivery_failed `fb9a04be`；验收 10/10（含 enforce 反向验证）；**不发版不重启**，装载等下个重启窗 | 交 I-2：`unified_inbox.html` 两处 `?v=`（cp-voice.js / cp-i18n.js）bump 到 20260904a（他线存量红 + 本条词典）；一个月后读台账定 enforce 规则表（`autosend_policy.decide` enforce 分支） | `发版对账_v1.0.72_A.md` | ≈$55（估） |
...
| **I-3** | 工作目标不推进（节奏档接线 / 摸底硬约束 / 画像兜底） | #153 #65 #40 #38 #152② | $190 | 未开工 | — | 全部 | `发版对账_v1.0.72_I3.md` | $0 |
| **I-4** | 地区语气自适应 + AI 自动链引用回复 | #40 #36后半 #37 | $190 | 未开工 | — | 全部 | `发版对账_v1.0.72_I4.md` | $0 |
| **I-5** | 老单清理五小件（LINE 媒体 / 克隆声 / 人设串味 / 删除同步 / UI） | #145 #32 | $190 | 未开工 | — | 全部 | `发版对账_v1.0.72_I5.md` | $0 |
