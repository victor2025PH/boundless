...
const COPY = {
  zh: {
    ...
    engineDesc: "五条产品线共享同一私有化底座：数据不出网、自主可控、全程 USDT 结算。",
    ctaPrimary: "查看套餐与价格",
    ctaSecondary: "了解品牌故事",
  },
  en: {
    ...
    engineDesc: "All five lines share one private-deployment core: data stays off-net, fully self-controlled, settled in USDT.",
