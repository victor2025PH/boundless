...
(function (root) {
  ...
  var DICT = {
    zh: {
      ...
      'conn.login_manual_out': '已退出登录。请用帐号密码登录；重新打开应用恢复主帐号自动登录',
    ...
    en: {
      ...
      'conn.login_manual_out': 'Signed out. Sign in with username & password; reopen the app to restore master auto sign-in',
