...
ZH = {
    ...
    "rps_al_hint": "最近 24 小时自动回复被拦下的次数，按原因码计：成人内容 / 风险保持 / 需人工 / 坐席刚发过（让位） / 坐席在打字（让位） / 档位切换 / 班表休息。让位两项从 v1.0.82 起只是延后不是丢稿，窗过自动发。",
    "rps_al_col_conv": "会话",
    "rps_al_col_time": "时间",
...
EN = {
    ...
    "rps_al_hint": "Auto-replies held back in the last 24h, by reason code: adult content / risk hold / needs human / agent just sent (yield) / agent typing (yield) / mode switched / off-hours schedule. Since v1.0.82 the two yield reasons only defer the draft — it auto-sends once the window passes.",
...
ZH_HANT = {
    ...
    "rps_al_hint": "最近 24 小時自動回覆被攔下的次數，按原因碼計：成人內容 / 風險保持 / 需人工 / 坐席剛發過（讓位） / 坐席在打字（讓位） / 檔位切換 / 班表休息。讓位兩項從 v1.0.82 起只是延後不是丟稿，窗過自動發。",
    "rps_al_col_conv": "會話",
    "rps_al_col_time": "時間",
    "rps_al_col_reason": "原因",
