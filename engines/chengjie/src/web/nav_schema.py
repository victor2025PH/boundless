...
NAV_ITEMS = {
    ...
    # Discord 刻意**不**挂 feature="rpa"：它是官方 Bot 应用（一个 Bot Token 走
    # Gateway 长连接），不是真机/协议逆向那一族，跟着 rpa 档位一起被锁没有道理
    # ——与 telegram 同样不标 feature。
    "discord": dict(key="discord", path="/workspace/channels/discord",
                    icon="discord", dot="discord",
                    label_key="nav_discord", label_zh="Discord Bot",
                    cmd_keys="discord dc bot 机器人 社群 服务器 频道 私信 渠道中心"),
...
NAV_GROUPS_FULL = [
    ...
    dict(label_key="section_channels", label_zh="渠道自动化",
         items=["rpa_overview", "telegram", "line_rpa", "messenger_rpa",
                "whatsapp_rpa", "discord", "group_show", DOMAIN_SENTINEL]),
...
SIMPLE_CORE = ["workspace", "cases", "care", "knowledge", DOMAIN_SENTINEL,
               ...
               "messenger_rpa", "whatsapp_rpa", "discord", "escalation"]
